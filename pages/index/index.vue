	...
	<view class="content">
		...
		<view class="" v-for="(key , index) in nava" style="margin-bottom: -8.3rem;">
			...
			<view
				...
				<view>
					<view>
						<image :src="key.data[0].img" @click="Shopp(nava[index].data[0].id)"
							style="width: 5rem;height: 5rem;"></image>
					</view>
		...
		<view class="c" style="width: 100%;">
			<view class="" v-for="(key , index) in shopping" @click="Shopp(shopping[index].id)"
				style="width: 46%;margin-left: 2%;float: left;">
