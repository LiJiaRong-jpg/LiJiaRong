<template>
	<view>
		<view v-for="(key,index) in DATA" style="padding-left: 10px;width: 100%;height: 3rem;clear: both;border-bottom: #C0C0C0 solid 1px;">
		...
		<view style="width: 80%;background-color: #fc4369;margin-left: 5%;border-radius: 1rem;
			...
			<text style="display: table;margin: auto;color: white;">新增地址</text>
		</view>
	</view>
</template>
