<template>
	<view class="content">
		...
		<view class="input" :style="back">
			...
			<input type="text" value="" placeholder="请输入宝贝名称" @click="input"/>
			<text class="iconfont">&#xe60c;</text>
		</view>
			...
			<view class="page-section swiper">
				<view class="page-section-spacing">
					<swiper class="swiper" indicator-dots="true" autoplay="true" interval="3000" duration="400">
						<swiper-item v-for="(key,index) in lunBo" @click="SHopp(lunBo[index].url)">
		...
		<view class="nav" style="margin: 2rem 0;">
			<view class="" v-for="(key , index) in nav" @click="SHopp(nav[index].url)">
				...
				<view style="width: 100%;height: 20rem">
					<view class="tab">
						<view class="tab-navA" style='font-size:12px;width: 100%;'>
							<view class="" v-for="(key , index) in chuChuang" @click="Shopp(chuChuang[index].spuId)"
		...
		<view class="" v-for="(key , index) in nava" style="margin-bottom: -8.3rem;">
			...
			<view
				...
				<view>
					<view>
						<image :src="key.data[0].img" @click="Shopp(nava[index].data[0].id)" style="width: 5rem;height: 5rem;"></image>
					</view>
		...
		<view class="c" style="width: 100%;">
			<view class="" v-for="(key , index) in shopping" @click="Shopp(shopping[index].id)" style="width: 46%;margin-left: 2%;float: left;">
